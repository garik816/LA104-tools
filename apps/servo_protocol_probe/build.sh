...
arm-none-eabi-g++ -std=gnu++11 -Wall -Os -Werror -fno-common -mcpu=cortex-m3 -mthumb -msoft-float \
  ...
  -I$ROOT/os_library/include -I$STDLIB/STM32F10x_StdPeriph_Driver/inc -I$ROOT/os_host/source \
  -I$STDLIB/CMSIS/Include -I$STDLIB/CMSIS/Device/STM32F10x/Include
...
arm-none-eabi-gcc -fPIC -mcpu=cortex-m3 -mthumb -o output.elf -nostartfiles -T ../app.lds \
  main.o can.o Serialize.o stm32f10x_can.o stm32f10x_gpio.o stm32f10x_rcc.o -lbios_la104 -L$ROOT/os_library/build
../../../../tools/elfstrip/elfstrip output.elf 144servoprobe.elf
